...
use neo_compiler::{
    error::Result,
    manifest::{ContractEventDefinition, ContractMethodDefinition, ContractParameterDefinition, Manifest},
    nef::NefFile,
    neo::OpCode,
    script::Script,
};
...
fn create_nep17_manifest() -> Result<Manifest> {
    ...
    manifest
        .set_extra("description", "Example NEP-17 token for demonstration purposes")
