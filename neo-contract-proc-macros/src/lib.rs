...
pub fn structs(_args: proc_macro::TokenStream, input: proc_macro::TokenStream) -> proc_macro::TokenStream {
    structs::expand_structs_impl(false, input)
}

/// inner_structs same as structs, but it is used for inner structs.
#[proc_macro_attribute]
pub fn inner_structs(_args: proc_macro::TokenStream, input: proc_macro::TokenStream) -> proc_macro::TokenStream {
    structs::expand_structs_impl(true, input)
}
