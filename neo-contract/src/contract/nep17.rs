...
impl NEP17Token {
    ...
    pub fn new(name: ByteString, symbol: ByteString, decimals: u8, total_supply: Int256) -> Self {
        Self { name, symbol, decimals, total_supply }
    }
...
impl NEP17 for NEP17Token {
    fn symbol(&self) -> ByteString { self.symbol.clone() }

    fn decimals(&self) -> u8 { self.decimals }

    fn total_supply(&self) -> Int256 { self.total_supply }

    fn balance_of(&self, _account: H160) -> Int256 { Int256::zero() }

    fn transfer(&mut self, _from: H160, _to: H160, _amount: Int256, _data: ByteString) -> bool { false }
}
