...
pub mod prelude {
    ...
    pub use crate::debug::{DebugCapture, TracingMode, DebugEvent, DebugEventType};
    pub use crate::assertions::*;
    pub use crate::{TestResult, TestError};
...
pub(crate) mod testing {
    ...
    pub mod mock_runtime {
        ...
        pub fn add_witness(hash: &[u8]) {
            MockRuntime::add_witness(hash);
        }
