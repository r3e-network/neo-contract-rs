...
# Step 3: Use neo-wasm to translate WASM to NEF directly
...
# Run neo-wasm translation - it will generate the manifest automatically
"$NEOWASM_BIN" translate --input "$WASM_FILE" --output "$NEF_FILE" --save-neo-ops

# Verify the manifest was created
if [[ ! -f "$MANIFEST_FILE" ]]; then
  echo "Error: Manifest file was not generated by neo-wasm."
