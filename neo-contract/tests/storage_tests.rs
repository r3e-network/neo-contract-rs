...
fn test_storage_map_contains_key() {
    ...
    let key = ByteString::from("test_key");
    let value = ByteString::from("test_value");
    let non_existent_key = ByteString::from("non_existent_key");
...
fn test_storage_map_multiple_operations() {
    ...
    // Test data
    let keys = [
        ByteString::from("key1"),
        ByteString::from("key2"),
        ByteString::from("key3"),
    ];
    
    let values = [
        ByteString::from("value1"),
        ByteString::from("value2"),
        ByteString::from("value3"),
    ];
    ...
    let new_value = ByteString::from("new_value1");
...
fn test_storage_map_empty_key_value() {
    ...
    let value = ByteString::from("value_for_empty_key");
    ...
    let key = ByteString::from("key_for_empty_value");
...
fn test_storage_map_special_characters() {
    ...
    let special_key = ByteString::from("!@#$%^&*()_+");
    let value = ByteString::from("value_for_special_key");
    ...
    let binary_key = ByteString::from_bytes(&[0x00, 0x01, 0xFF, 0xFE]);
    let binary_value = ByteString::from_bytes(&[0xAA, 0xBB, 0xCC, 0xDD]);
...
fn test_storage_map_overwrite() {
    ...
    // Test data
    let key = ByteString::from("overwrite_key");
    let value1 = ByteString::from("initial_value");
    let value2 = ByteString::from("updated_value");
