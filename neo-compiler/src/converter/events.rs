...
pub fn emit_event(script: &mut Script, event_name: &str, params: &[EventParamType]) -> Result<(), Error> {
...
/// }
/// ```
pub fn insert_param_to_any_conversion(_script: &mut Script, param_type: &EventParamType) -> Result<(), Error> {
