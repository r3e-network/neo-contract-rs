...
use crate::prelude::{Any, Array, ByteString, Int256, H160, H256};
use crate::Runtime;
...
/// Ledger script hash
pub fn script_hash() -> H160 { H160::from_hex("da65b600f7124ce6c79950c1772a36403104f2be").unwrap_or_else(H160::zero) }
...
impl Ledger {
    ...
    pub fn current_index() -> u32 {
        ...
        let _result = Runtime::call_contract(Ledger::hash(), method, args);
    ...
    pub fn hash_at(index: u32) -> H256 {
        ...
        let result = Runtime::call_contract(Ledger::hash(), method, args);
