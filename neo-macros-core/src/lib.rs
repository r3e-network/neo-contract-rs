...
//! ## Overview
//!
//! This crate contains all declarative macros (`macro_rules!`) for Neo N3 smart contract
//! development, separated from procedural macros to respect Rust's technical 
//! limitations on proc-macro crates.
//!
//! ## Categories of Macros
//!
//! - **Event Macros**: For emitting events and implementing event traits
//! - **Profiling Macros**: For measuring performance and gas usage
//! - **Utility Macros**: Various utilities for Neo smart contracts
