...
impl H256 {
    pub fn from_literal(p0: &str) -> Self { H256::from_slice(&hex::decode(p0).unwrap()) }
}

impl H256 {
    /// Creates a new H256 with all zeros
    pub fn zero() -> Self { H256([0; 32]) }
...
impl fmt::Debug for H256 {
    fn fmt(&self, f: &mut fmt::Formatter) -> fmt::Result { write!(f, "H256(0x{})", self.to_hex()) }
}
